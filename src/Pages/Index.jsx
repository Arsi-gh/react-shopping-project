  ...
  return (
    <>
      ...
      <Title text="What are you looking for ?">
        <MagnifyingGlassCircleIcon className="w-[2.5rem] h-[2.5rem] text-green-700 max-sm:w-[1.8rem]"/>
      </Title>
      <CategoryBoxes/>
      <Title text="Plant store subscription">
        <SparklesIcon className="w-[2.5rem] h-[2.5rem] text-green-700 max-sm:w-[1.8rem]"/> 
      </Title>
      <Subscription/>
      <Title text="How job get done in here">
        <BriefcaseIcon className="w-[2.5rem] h-[2.5rem] text-green-700 max-sm:w-[1.8rem]"/> 
      </Title>
      <JobInfo/>
      <Title text="Some of our documents" href="/documents">
        <DocumentTextIcon className="w-[2.5rem] h-[2.5rem] text-green-700 max-sm:w-[1.8rem]"/> 
      </Title>
      <DocumentShowcase/>
      <EmailBox/>
      <Contact/>
