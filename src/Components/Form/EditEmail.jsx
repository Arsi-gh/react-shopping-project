...
export default function EditEmail({displayHandler}) {
    return (
        <>
          ...
          <form className="flex flex-col p-4 gap-4 rounded-lg bg-neutral-200 fixed transform -translate-x-[50%] left-[50%] sm:top-[25%]  w-[25rem] max-sm:w-full max-sm:top-[65%] max-sm:bottom-0 max-sm:rounded-none max-sm:rounded-t-xl max-sm:p-4">
            ...
            <button className="p-2 bg-green-500 text-white font-bold rounded-lg">Send verify code</button>
          </form>
        </>
    )
}
