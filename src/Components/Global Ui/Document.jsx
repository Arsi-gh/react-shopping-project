...
export default function DocumentItem() {
  return (
    <div className="w-[25rem] max-h-[18rem] rounded-lg overflow-hidden justify-between cursor-pointer shadow-customeTwo relative max-lg:w-[48%] max-md:rounded-none max-md:shadow-none max-md:border-y-[1px] border-zinc-300 max-md:h-auto max-md:w-full max-sm:w-full">
