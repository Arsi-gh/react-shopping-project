...
export default function Footer() {
    return (
        <footer className="mt-20 mx-auto bg-gradient-to-t from-neutral-100 to-neutral-200 rounded-t-[3rem] overflow-hidden">
          <div className="max-w-[1600px] flex flex-col m-auto">
            <div className="w-full flex flex-wrap h-fit justify-between gap-[1rem] gap-x-[8rem] p-[2rem] px-[4rem] max-sm:flex-col">
              <div className="flex-1">
                <h3 className="my-[0.5rem] font-semibold text-lg">Plant store</h3>
              ...
              <div className="flex-1 h-[10rem]">
                <h3 className="-ml-[1rem] m-[0.5rem] font-semibold text-lg">Categories</h3>
                <ul>
              ...
              <div className="flex-1 h-[10rem]">
                <h3 className="-ml-[1rem] m-[0.5rem] font-semibold text-lg">Any problem ?</h3>
                <ul>
              ...
              <div className="flex-1 h-[10rem]">
                <h3 className="-ml-[1rem] m-[0.5rem] font-semibold text-lg">Plant store</h3>
                <ul>
