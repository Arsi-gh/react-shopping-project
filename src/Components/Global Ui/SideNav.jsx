...
export default function SideNav({toggleDisplay}) {
    return (
        ...
        <section className="flex flex-col fixed left-0 top-0 bg-zinc-200 w-[15rem] h-screen z-20">
            ...
            <NavLink onClick={() => toggleDisplay(false)} to="/about-us" className="flex justify-between  p-4 px-6 hover:bg-stone-100">About us <InformationCircleIcon className="w-[1.5rem]"/></NavLink>
